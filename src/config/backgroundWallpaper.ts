...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			...
			"assets/images/DesktopWallpaper/c9.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		...
		mobile: [
			...
			"assets/images/MobileWallpaper/mc1.png",
			"assets/images/MobileWallpaper/mc2.png",
			"assets/images/MobileWallpaper/mc3.jpg",
			"assets/images/MobileWallpaper/mc4.png",
			"assets/images/MobileWallpaper/mc5.jpg",
			"assets/images/MobileWallpaper/mc6.png",
			"assets/images/MobileWallpaper/mc7.jpg",
			"assets/images/MobileWallpaper/mc8.png",
			"assets/images/MobileWallpaper/mc9.jpg",
			"assets/images/MobileWallpaper/mc10.png",
			"assets/images/MobileWallpaper/mc11.jpg",
			"assets/images/MobileWallpaper/mc12.jpg",
			"assets/images/MobileWallpaper/mc13.webp",
		],
		// 背景视频播放地址
